...
# Clone our phpBB fork
sudo git clone https://github.com/ClutchEngineering/phpbb.git /workspaces/phpbb
...
# Install our theme
sudo ln -s /workspaces/phpbb-theme-prosilver_se /var/www/html/phpbb/phpBB/styles/prosilver_se
